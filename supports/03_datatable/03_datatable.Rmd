...
Il existe des alternatives à `dplyr::case_when` qui n'utilisent pas de surcouche par rapport au langage base `lest::case_when`. En exercice, vous pouvez tester cette solution. Elle est néanmoins moins rapide que le remplacement conditionnel `data.table`


### Subsetting des colonnes et mot clé `.SD`
