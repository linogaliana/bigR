...
Pour montrer l'intérêt des fonctions d'import/export de `data.table` nous allons utiliser la base de données `sirus` 2017 (extrait de Sirene) qui avait servi 
